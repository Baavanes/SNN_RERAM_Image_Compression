...
# Cut all timing arcs inside/through the X1 macro instance.
set mprj_cell [get_cells -hierarchical img_comp_inst.x1_core.synapse_matrix_inst.X1_inst]
if {[llength $mprj_cell]} {
    set_disable_timing $mprj_cell

    # Extra safety: also cut any paths that pass through macro pins
    set mprj_pins [get_pins -hierarchical img_comp_inst.x1_core.synapse_matrix_inst.X1_inst/*]
